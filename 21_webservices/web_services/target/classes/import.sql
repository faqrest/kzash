...
INSERT INTO order_type (type_name) VALUES ('booking');

INSERT INTO book (name, author_id, publishing_house_id, genre_id, total_count, current_count, place_id, read_count, language_id) VALUES ('Misery','1','1','3', '7','7', '1', '2', '1');
INSERT INTO book (name, author_id, publishing_house_id, genre_id, total_count, current_count, place_id, read_count, language_id) VALUES ('Financier','2','2','4','4','4', '2', '2', '3');
INSERT INTO book (name, author_id, publishing_house_id, genre_id, total_count, current_count, place_id, read_count, language_id) VALUES ('Harry Potter and the philosopher`s stone','3','1','5', '9','9', '2', '13', '2');
INSERT INTO book (name, author_id, publishing_house_id, genre_id, total_count, current_count, place_id, read_count, language_id) VALUES ('Harry Potter and room of Secrets','3','1','5', '9','9', '2', '19', '2');
...
INSERT INTO user (first_name, last_name, role_id, password, e_mail, phone, address_id, document) VALUES ('Vasiliy', 'Ivanov', '2', 'vas1', 'vasyok@gmail.com', '+380500500112', 1, true);
...
INSERT INTO orders (book_id, user_id, order_date, expected_return_date, order_type_id) VALUES ('1', '1', '2016-12-12', '2017-12-12', 1);
INSERT INTO orders (book_id, user_id, order_date, expected_return_date, actual_return_date, order_type_id) VALUES ('2', '4', '2016-11-15', '2017-12-11','2017-12-10', 1);
INSERT INTO orders (book_id, user_id, order_date, expected_return_date, actual_return_date, order_type_id) VALUES ('2', '7', '2016-11-15', '2017-12-11','2017-12-10', 1);
